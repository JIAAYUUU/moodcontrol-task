...
let expName = 'MoodControlTask';  // from the Builder filename that created this script
...
function instructionLoop1LoopBegin(thisScheduler) {
  ...
  trialIterator = instructionLoop1[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisInstructionLoop1 = result.value;
...
function instructionLoop2LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = instructionLoop2[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisInstructionLoop2 = result.value;
...
function trialLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = trialLoop[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisTrialLoop = result.value;
...
function doRatingLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = doRatingLoop[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisDoRatingLoop = result.value;
...
function trialHappyLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = trialHappyLoop[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisTrialHappyLoop = result.value;
...
function logWinningsLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = logWinningsLoop[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisLogWinningsLoop = result.value;
...
function lifeHappyRoutineBegin() {
  ...
  lifeHappyComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function blockHappyRoutineBegin() {
  ...
  blockHappyComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function getAnswerRoutineBegin() {
  ...
  getAnswerComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function showChoiceRoutineBegin() {
  ...
  showChoiceComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function showResultRoutineBegin() {
  ...
  showResultComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function trialHappyRoutineBegin() {
  ...
  trialHappyComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function blockRestRoutineBegin() {
  ...
  blockRestComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function showWinningsRoutineBegin() {
  ...
  showWinningsComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function showHashRoutineBegin() {
  ...
  showHashComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
